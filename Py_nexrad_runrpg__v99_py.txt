...
#
program_name="Py_nexrad_runrpg__v99q.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
ksh_scripts='/import/frb_archive/pmccrone/Scripts/runrpg/ksh_scripts2024Q/' #### Make sure ksh_scripts ends with a /.
...
try:
    ...
    dataset=PD.read_excel(file, sheet_name="Cool Season Cases(Q)")
    #
