...
#
program_name="Py_nexrad_runrpg__v6_a.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
ksh_scripts='/import/frb_archive/pmccrone/Scripts/runrpg/ksh_scripts2023C/' #### Make sure ksh_scripts ends with a /.
...
file=CWD_PATH+'F-Shield-Testing-Cases.xlsx'
...
try:
    ...
    dataset=PD.read_excel(file, sheet_name="F-Shield Testing (ISDP=ON) Warm")
    #
...
expect_col_1  = 'Radar Site'
expect_col_6  = 'File Location Level-II Data (Linux)'
expect_col_12 = 'File Location  Level-III Products (Linux)'
expect_col_14 = 'Est. ISDP pulled from ASP log, use with "show_isdp" command.'
expect_col_29 = 'Max Range for R(A) usage (km)'
expect_col_30 = 'Job Number'
expect_col_31 = 'Execute?'
expect_col_3x = 'Execute? (must be set to \'yes\' to run'
...
print(DADASHES)
#
# Check the names of the columns ti ensure they are correct
#
column_name_check = 0
#
# Col 1
#
if col_radar_site in expect_col_1:
    print("Column 1 - OK")
    column_name_check = 1
else:
    print("ERROR: Column 1 - NOT OK")
    column_name_check = 0
#
# Col 6
#
if col_levelII in expect_col_6:
    print("Column 6 - OK")
    column_name_check = 1
else:
    print("ERROR: Column 6 - NOT OK")
    column_name_check = 0
#
# Col 12
#
if col_level3 in expect_col_12:
    print("Column 12 - OK")
    column_name_check = 1
else:
    print("ERROR: Column 12 - NOT OK")
    column_name_check = 0
#
# Col 14
#
if col_ISDP in expect_col_14:
    print("Column 14 - OK")
    column_name_check = 1
else:
    print("ERROR: Column 14 - NOT OK")
    column_name_check = 0
#
# Col 29
#
print(DADASHES)
print("col_maxrange=  "+str(col_maxrange))
print("expect_col_29= "+str(expect_col_29))

if col_maxrange in expect_col_29:
    print("Column 29 - OK")
    column_name_check = 1
else:
    print("ERROR: Column 29 - NOT OK")
    column_name_check = 0
#
# Col 30
#
if col_Job_number in expect_col_30:
    print("Column 30 - OK")
    column_name_check = 1
else:
    print("ERROR: Column 30 - NOT OK")
    column_name_check = 0
#
# Col 31
#
print(DADASHES)
#
print("col_execute=   "+str(col_execute))
print("expect_col_31= "+str(expect_col_31))
print("expect_col_3x= "+str(expect_col_3x))
#

if (col_execute == expect_col_31) or (col_execute == expect_col_3x):
    print("Column 31 - OK")
    column_name_check = 1
else:
    print("ERROR: Column 31 - NOT OK")
    column_name_check = 0
#
#-----------------------------------------------------------#
#
...
for x in dataset.index:
    ...
    if rowx_radarsite not in ALL_call_signs:
        print('ERROR:: The radar identifer in this case, >'+str(rowx_radarsite)+'<, is NOT Valid. We will go to the next run and not build scripts. ')
...
#
    ...
    if execute_permit:     # We spent effort to ensure execute_permit is only set to true if there are no errors.
        ...
        print("\nBE ADVISED: Case Number: "+str(rowx_Job_number)+" was set to no.\nWe will not make files for this case.")
