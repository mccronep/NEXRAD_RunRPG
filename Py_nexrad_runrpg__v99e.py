...
#
program_name="Py_nexrad_runrpg__v99e.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
ksh_scripts='/import/frb_archive/pmccrone/Scripts/runrpg/ksh_scripts2024O/' #### Make sure ksh_scripts ends with a /.
...
try:
    ...
    dataset=PD.read_excel(file, sheet_name="Cool Season Cases")
    #
