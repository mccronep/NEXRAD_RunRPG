...
#
program_name="Py_nexrad_runrpg__v4.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
"KEMX","KINX","KVNX","KVBX","KICT","KLTX","KFFC","KYUX","KLGX","KGSP"]
#
...
"KLGX":"Langley-Hill_WA","KGSP":"Greer_SC"}
...
ksh_scripts='/import/frb_archive/pmccrone/Scripts/runrpg/ksh_scripts2023B/' #### Make sure ksh_scripts ends with a /.
...
#
    ...
    if execute_permit:     # We spent effort to ensure execute_permit is only set to true if there are no errors.
        ...
        seventh_line="echo If you are rerunning this- remove all files with the command rm -rf star.star "
