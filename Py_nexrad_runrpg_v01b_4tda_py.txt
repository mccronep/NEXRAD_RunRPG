...
#
program_name="Py_nexrad_runrpg_v01a_4tda.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
ksh_scripts='/import/frb_archive/pmccrone/Scripts/runrpg/ksh_scripts2024T/' #### Make sure ksh_scripts ends with a /.
...
file=CWD_PATH+'TDA_data_case_set_1.xlsx'
...
try:
    ...
    #dataset=PD.read_excel(file, sheet_name="Warm Season Cases(N)")
    dataset=PD.read_excel(file, sheet_name="Supercell Kentucky")
    #
...
#
    ...
    if execute_permit:     # We spent effort to ensure execute_permit is only set to true if there are no errors.
        ...
        fourth_line ="/home/pmccrone/python/src/ecl/ecl3sb_tda 1 "+str(rowx_level3)         ### PYTHON 3
        # This line above was changed for TDA only. PJM 10-16-24..
        fifth_line  ="\n"
