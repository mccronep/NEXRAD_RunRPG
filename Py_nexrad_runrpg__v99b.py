...
#
program_name="Py_nexrad_runrpg__v99b.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
ksh_scripts='/import/frb_archive/pmccrone/Scripts/runrpg/ksh_scripts2024L/' #### Make sure ksh_scripts ends with a /.
...
try:
    ...
    dataset=PD.read_excel(file, sheet_name="Warm Season Cases")
    #
