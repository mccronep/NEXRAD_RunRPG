...
#
    ...
    #
    print("File name: case"+str(rowx_Job_number)+"screen3.ksh\n")
    print("#!/bin/ksh")
    print("#")
    print("# Screen 3 playback instructions")
    print("/export/home/orpg2/bin/lnux_x86/mrpg cleanup\n")
    print("/export/home/orpg2/bin/lnux_x86/cad "+rowx_radarsite.lower()+" 1\n")
    print("/export/home/orpg2/bin/lnux_x86/mrpg -p startup\n")
    ## The [:2] is to remove the decimal from the ISDP.
    rowx_ISDP2 = str(rowx_ISDP)[:2]
    print("/export/home/orpg2/bin/lnux_x86/show_isdp -i "+str(rowx_ISDP2)+"\n")
    print("/export/home/orpg2/bin/lnux_x86/hci &\n")
    print("\n\n")
    #
    print(DADOTS+" 2")
    ...
    print("#!/bin/ksh")
    print("#")
    print("# Screen 2 playback instructions")
    print("/export/home/orpg2/bin/ecl 1 "+str(rowx_level3))
    #
    print("\n")
    print(DADOTS+" 0")
    ...
    print("#!/bin/ksh")
    print("#")
    print("# Screen 0 playback instructions")
    print("cd "+str(rowx_levelII))
    print("/export/home/orpg2/bin/lnux_x86/play_a2 -i\n")
    print("\n")
    #
    print(DADOTS+" 4")
    ...
    print("#!/bin/ksh")
    print("#")
    print("# Screen 4 playback instructions")
    print("/usr/bin/script "+str(rowx_level3)+"/lem_capture.txt\n")
    print("#capture\n")
    print("/export/home/orpg2/bin/lnux_x86/lem qperate | grep --color=never -e alpha  -e Alpha -e Count -e VolumeStartTime\n")
    #End loop
