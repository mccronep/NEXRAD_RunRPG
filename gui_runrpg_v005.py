...
if valid_thisfile:
    ...
    #
    print("---CAUTION---")
    print("---The indicated file -zenityfileselect.sh- is INVALID! NEED TO CHECK THIS!: "+LINUXCOM)
    MYERRTEXT="---The indicated file -zenityfileselect.sh- is INVALID! NEED TO CHECK THIS!: "+LINUXCOM
    BIGERRORLIST.append(MYERRTEXT)
    #
    THIS_RETURN_VALUE = 0
    WARNING_INIT_ERROR=0
...
if valid_thisfile:
    ...
    #
    print("---CAUTION---")
    print("---The indicated file -zenitylistselect.sh- is INVALID! NEED TO CHECK THIS!: \n"+LINUXCOM)
    MYERRTEXT="---The indicated file -zenitylistselect.sh- is INVALID! NEED TO CHECK THIS!: \n"+LINUXCOM
    BIGERRORLIST.append(MYERRTEXT)
    #
    THIS_RETURN_VALUE = 0
    WARNING_INIT_ERROR=0
...
for x in dataset.index:
    ...
    if (VALID_THISPATH and EXECUTE_PERMIT==True):
        print(DADASH)
