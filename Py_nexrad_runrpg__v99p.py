...
# NAME:
# :::::::::::::::::::::::::::::::::::::::::::::::
# Py_nexrad_runrpg__v99p.py 
# :::::::::::::::::::::::::::::::::::::::::::::::
#
#  PROGRAM OVERVIEW:
#       (0) The PYTHON CODE reads case information from an FRB google sheet.
#           The Google sheet is NA24-00059_v2_Tet.xlsx for R(A) Mod -internal - for
...
# Modification  :  BELOW
#========================================================================================
#  Version 1.0   , Dated 2023-Aug-11
#                  Initial Build.
#  Version 1.5   , Dated 2024-May-22  
#========================================================================================
...
#
program_name="Py_nexrad_runrpg__v99p.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
if valid_thispath:
    ...
    this_return_value = 1
    WARNING_INIT_ERROR=1cd /home/pmccrone/anaconda3/bin
    print(dadash)
    #
else:
    #
...
ksh_scripts='/import/frb_archive/pmccrone/Scripts/runrpg/ksh_scripts2024P/' #### Make sure ksh_scripts ends with a /.
...
#file=CWD_PATH+'NA22-00161.xlsx'
#file=CWD_PATH+'NA23-00082_v2.xlsx'
#file=CWD_PATH+'NA22-00161_v2.xlsx'
#file=CWD_PATH+'NA24-00059_v3_Test.xlsx'
#file=CWD_PATH+'NA24-00059_v3_Test2.xlsx'
file=CWD_PATH+'Build_24_v1_Test_v1.xlsx'
...
try:
    ...
    dataset=PD.read_excel(file, sheet_name="Warm Season Cases(P)")
    #dataset=PD.read_excel(file, sheet_name="Cool Season Cases(O)")
    #
...
# No.  Name: 
#  1 - 'Radar Site'                                      	      (B)   # 1
#  6 - 'File Location Level-II Data (Linux)'                          (G)   # 6 
# 12 - 'File Location  Level-III Products (Linux)'                    (M)   # 12
# 14 - 'Est. ISDP pulled from ASP log, use with "show_isdp" command.' (O)   # 14 
# 29 - 'Max Range for R(A) usage (km)'                                (AD)  # 29
# 30 - 'Job Number' - This is the job number for scripts.             (AE)  # 30
# 31 - 'Execute?'   - This tells the program if the scripts           (AF)  # 31
