...
#
program_name="Py_nexrad_runrpg__v3.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
ksh_scripts='/import/frb_archive/pmccrone/Scripts/runrpg/ksh_scripts2023A/' #### Make sure ksh_scripts ends with a /.
...
#
    ...
    if execute_permit:     # We spent effort to ensure execute_permit is only set to true if there are no errors.
        ...
        fourth_line ="/export/home/orpg2/bin/lnux_x86/mrpg cleanup\n"
        fifth_line  ="/export/home/orpg2/bin/lnux_x86/cad "+rowx_radarsite.lower()+" 1\n"
        sixth_line  ="/export/home/orpg2/bin/lnux_x86/mrpg -p startup\n"
        ## The [:2] is to remove the decimal from the ISDP.
        rowx_ISDP2  = str(rowx_ISDP)[:2]
        seventh_line="/export/home/orpg2/bin/lnux_x86/show_isdp -i "+str(rowx_ISDP2)+"\n"
        eigth_line  ="/export/home/orpg2/bin/lnux_x86/hci &\n"
        ninth_line  ="\n\n"
        ...
        #fifth_line  ="/export/home/orpg2/bin/lnux_x86/play_a2 -i\n"                      ### THIS IS THE ORIGINAL BINARY
        ...
        fifth_line  ="#capture\n"
        sixth_line  ="/export/home/orpg2/bin/lnux_x86/lem qperate | grep --color=never -e alpha  -e Alpha -e Count -e VolumeStartTime\n"
        script_list_set=[first_line, second_line, third_line, fourth_line, fifth_line, sixth_line]
        for new_line in script_list_set:
            print(new_line)
            writefileobj.write(new_line)
